...
func TestRequestLineParseByChunks(t *testing.T) {
	// Test: Good GET Request line
	reader := &chunkReader{
		data:            "GET / HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n",
		numBytesPerRead: 3,
...
func TestHeaders(t *testing.T) {
	// Test: Standard Headers + case insensitive header key
	reader := &chunkReader{
		data:            "GET / HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n",
		numBytesPerRead: 3,
	}
	...
	reader = &chunkReader{
		data:            "GET /coffee HTTP/1.1\r\nExisting: Early bird\r\nExisting: I think therefore\r\n\r\n",
		numBytesPerRead: 3,
	}
	r, err = RequestFromReader(reader)
	assert.Equal(t, "Early bird, I think therefore", r.Headers["existing"])
	...
	r, err = RequestFromReader(reader)
	assert.ErrorIs(t, err, ERROR_EOF_B4_END)
